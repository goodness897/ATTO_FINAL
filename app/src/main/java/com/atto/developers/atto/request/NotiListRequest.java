...
import com.atto.developers.atto.networkdata.notidata.NotiListItemData;
 ...
 */
public class NotiListRequest  extends AbstractRequest<ListData<NotiListItemData>> {
    Request mRequest;
    ...
    public NotiListRequest(Context context,String tid, String page_no, String row_count) {
        //거래글 리스트
    ...
    protected Type getType() {
        return new TypeToken<ListData<NotiListItemData>>() {
        }.getType();
    }
